...
async def test_agent_initialization():
    ...
    try:
        ...
        tracing_enabled = (
            hasattr(agent, "orchestrating_agent") and agent.orchestrating_agent is not None
        )
...
async def main():
    ...
    print("\n📖 For more information, see: docs/guides/workflows/agent-tracing-guide.md")
