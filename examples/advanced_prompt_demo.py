...
async def demo_advanced_prompt_system():
    ...
    for i, scenario in enumerate(test_scenarios, 1):
        ...
        try:
            ...
            print("📊 Generated workflow analysis:")
            ...
            print(
                f"   - Performance analysis: {'✅' if params.get('include_performance_analysis') else '❌'}"
            )
    ...
    if original_prompt:
        try:
            ...
            original_result = await original_instance.get_prompt(
                mock_ctx, earliest_time="-24h", latest_time="now"
            )
            ...
            print(
                f"{'Arguments supported':<35} {len(original_prompt.arguments):<12} {len(multi_agent_prompt.arguments):<12}"
            )
