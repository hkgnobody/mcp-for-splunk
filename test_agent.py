...
Examples:
  ...
  # Test with explicit prompt flag
  python test_agent.py --prompt "Searches are running very slowly and consuming high CPU"
  
  # Test missing data with specific index
  python test_agent.py --prompt "I can't find my data" --focus-index "main"
