...
from test_agent import TestConfig, test_splunk_triage_agent, logger
...
def get_test_scenarios():
    ...
    return {
        ...
        "performance": TestConfig(
            test_input="My searches are running very slowly and timing out",
        ...
        "indexing": TestConfig(
            test_input="There are delays in data indexing and high latency",
            complexity_level="high"
        ),
        "general": TestConfig(
