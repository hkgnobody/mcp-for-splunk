...
class BaseTool(ABC):
    ...
    def get_client_config_from_context(self, ctx: Context) -> Optional[Dict[str, Any]]:
        """
    ...
    async def get_splunk_service(self, ctx: Context, tool_level_config: Optional[Dict[str, Any]] = None) -> client.Service:
        """
