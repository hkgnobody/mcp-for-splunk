...
class ToolCallResponse(BaseModel):
    ...
    result: Optional[ToolCallResponseResult] = None
    id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["jsonrpc", "result", "id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": ToolCallResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None,
            "id": obj.get("id")
        })
        return _obj
