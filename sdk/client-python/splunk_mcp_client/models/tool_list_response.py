...
class ToolListResponse(BaseModel):
    ...
    result: Optional[ToolListResponseResult] = None
    __properties: ClassVar[List[str]] = ["jsonrpc", "result"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": ToolListResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
